...
export default function Profile(props) {
  ...
  return (
    <ProfileEl>
      ...
      <Name>{ props.user }<BsFillPatchCheckFill /> </Name>
      ...
      {modalIsOpen && (
        <Modal followers={props.followerList}onCancel={closeModalHandler} />
      )}
      ...
      <Bio>{props.bio}</Bio>
          <Stats>
            ...
            <StatItem>
            <StatTitle><a onClick={openHandler}>Followers</a></StatTitle>
              <StatValue>{props.followers}</StatValue>
            </StatItem>
            <StatItem>
              <StatTitle><a href="www.google.com">Following</a></StatTitle>
