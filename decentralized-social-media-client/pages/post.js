...
export default function PostPage() {
	...
	return (
		<Post comments={commentData} commentauth={commentauth} commentavi={commentavi} id={id} img={img} caption={caption} likes={likes} views={views} author={author} avatar={avi}
		/>
	);
}
